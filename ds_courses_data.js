const DS_DATA = {
    title: "إتقان الخوارزميات وهياكل البيانات",
    description: "أتقن الخوارزميات وهياكل البيانات المختلفة",
    instructor: "إبراهيم جبر",
    instructorImage: "/gabr.jpg",
    numOfHours: "12",
    numOfVideos: "66",
    ...
    sections: [
        ...
        },
        {
            ...
            "imageAlt": "",
            "description": "هذه الدورة الأولى في سلسلة دورات الذكاء الصناعي وعلوم البيانات وهي دورة قوية ومهمة لكل طالب ذكاء صناعي",
            "title": "أوامر التحكم في البايثون",
            "level": "مستوى مبتديء",
            "price": "مجانا",
            "duration": "74",
            "insteadPrice": null,
...
export function getDsCourses() {
    return DS_DATA;
}

export function getCourseId(courseId) {
    const course = DS_DATA.filter((course) => course.id === courseId);
    return course[0];
}